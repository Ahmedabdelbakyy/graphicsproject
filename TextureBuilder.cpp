#define _CRT_SECURE_NO_WARNINGS // <--- Fixes fopen warning
...
// --- FIX: Define missing OpenGL constant for Windows ---
...
static void setParams(bool wrap) {
    ...
    // This line caused the error because GL_CLAMP_TO_EDGE was undefined
